      ...
      <>
          <div className="m-auto lg:space-s-8 w-full md:py-10 py-3 md:mb-10 mb-3 px-4 md:px-6 max-w-[1640px] twxl_px_none lg:px-8 category_section_wrap">
              <div className="relative !ml-0 inner">
                  ...
                  <div
                      ref={prevRef}
                      className="banner-slider-prev group_nav_prev hidden md:flex items-center justify-center text-heading bg-light outline-none absolute top-[50%] -mt-4 z-10 cursor-pointer -start-[30px] lg:left-[-32px] focus:outline-none transition-all duration-200 text-[#000] hover:text-[#14B1F0]"
                  >
                      <span className="sr-only">{('text-previous')}</span>
                      <ArrowPrevIcon className="w-[45px] text-[#000] hover:text-[#14B1F0]" />
                  </div>
                  <div
                      ref={nextRef}
                      className="banner-slider-next group_nav_next hidden md:flex items-center justify-center text-heading bg-light outline-none absolute top-[50%] -mt-4 z-10 cursor-pointer -end-[30px] lg:right-[-32px] focus:outline-none transition-all duration-200 text-[#000] hover:text-[#14B1F0]"
                  >
                      <span className="sr-only">{('text-next')}</span>
                      <ArrowNextIcon className="w-[45px] text-[#000] hover:text-[#14B1F0]" />
                  </div>
            </div>
        </div>
