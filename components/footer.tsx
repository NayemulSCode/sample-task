...
const Footer = () => {
  return (
      <footer className="w-full">
          <div>
            <div className="w-full max-w-[1640px]  twxl_px_none mx-auto bg-[#393939] text-[#ffffff] lg:px-6 md:px-4 px-3 md:pt-[70px] pt-[40px] md:grid lg:grid-cols-[22.3%,22.3%,22.3%,30.3%] md:grid-cols-[20%,40%,30%] relative">
              ...
              <div className="flex justify-end mx-auto bg-[#393939] border-b border-[#676464bf] md:px-4 px-3 md:pb-[60px] pb-[40px]">
                    <ul className="flex items-center text-[#fff]">
