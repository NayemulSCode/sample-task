...
const Footer = () => {
  return (
    <footer className="w-full">
      <div>
        <div className="w-full max-w-[1640px]  twxl_px_none mx-auto bg-[#393939] text-[#ffffff] lg:px-6 md:px-4 px-3 md:pt-[70px] pt-[40px] md:grid lg:grid-cols-[22.3%,22.3%,22.3%,30.3%] md:grid-cols-[20%,40%,30%] relative justify-center">
          <div className="md:mb-0 mb-[20px]">
            ...
            <ul className="md:mb-0 mb-[20px]">
              <li className="md:mb-4 mb-[8px] flex align-middle gap-2">
                <h6 className="md:text-[14px] text-[#00CAD7] text-[13px] font-bold ">
              ...
              <li className="md:mb-4 mb-0 flex align-middle gap-2">
                <Link href="mailto:info@winstore.pk">
                  <p className="text-[13px] text-[#FFFFFF]">info@winstore.pk</p>
                </Link>
              </li>
            </ul>
          ...
          <div className="md:mb-0 md:px-3 px-0 mb-[20px]">
            ...
            <div className="">
              <ul className="md:mb-6 lg:mr-[100px]">
                ...
                <li className="md:mb-1 mb-0">
                  <Link href="#">
                    <p className="text-[13px] hover:underline">FAQs</p>
                  </Link>
                </li>
                <li className="md:mb-1 mb-0">
                  <Link href="#">
          ...
          <div className="md:mb-0 md:px-3 px-0">
            ...
            <div className="">
              <ul className="md:mb-6 lg:mr-[100px]">
                ...
                <li className="md:mb-1 mb-0">
                  <Link href="#">
                    <p className="text-[13px] hover:underline">Wishlist</p>
                  </Link>
                </li>
                <li className="md:mb-1 mb-0">
                  <Link href="#">
        ...
        <div className="grid md:grid-cols-[47%,53%] grid-cols-1 max-w-[1640px] justify-between  mx-auto bg-[#393939] border-b border-[#676464bf] md:px-4 px-3 md:pb-[60px] pb-[40px]">
          <div className="w-full"></div>
          <div>
            <ul className="flex justify-start w-full text-[#fff]">
